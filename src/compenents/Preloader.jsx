    ...
    >
        <div className='w-full h-full sm:relative flex flex-col-reverse justify-center items-center'>
            <div className="loadingText sm:absolute bottom-0 left-4">
                <h1 className='text-[#DDDDD5] font-["Walkway_Expand_Black"] tracking-wider sm:text-[10vw] text-[11vw] font-bold'>CODESMITH</h1>
            </div>
            <div className='loadingNumber sm:absolute bottom-[12rem] left-[3rem]'>
      <h1 className='text-black font-["Walkway_Expand_Black"] sm:text-7xl text-4xl font-bold'>{`${count}%`}</h1>
            </div>
        </div>
    </div>
  )
